                ...
                return Container(
                  ...
                  child: Material(
                    ...
                    child: Container(
                      ...
                      margin: EdgeInsets.only(left: 20.0,right: 20.0,top: 20.0,bottom: 10),
                      child: Row(
                        ...
                        children: [
                          ...
                          ClipRRect(
                              ...
                              child: Image.network(ds["Image"],height: 50,width: 90,fit: BoxFit.cover,)),

                          SizedBox(width: 20.0,),
                          Column(
                            children: [
                              Text(ds["Name"],style: AppStyle.semiBoldTextFieldStyle(),)
                              ,
                              Text("\$"+ds["Total"],style: AppStyle.semiBoldTextFieldStyle(),)
                            ],
                          )
                        ],
                      ),
...
Padding(
  ...
  child: Row(
    ...
    children: [
      Text("Total Price",style: AppStyle.boldTextFieldStyle(),),
      Text("\$"+
          ...
          total.toString(),style: AppStyle.semiBoldTextFieldStyle(),)
    ],
  ),
),
